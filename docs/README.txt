...
--------------------------------------------------
The bottom of the page shows a version, e.g. "Signature app v7".

After deploying, open your address and look at it. If it does not say v7,
...
Quick way to tell by eye:
   v7 - the logo sits to the LEFT of the text.   <- correct
